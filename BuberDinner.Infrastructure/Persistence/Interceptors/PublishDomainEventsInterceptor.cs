...
public class PublishDomainEventsInterceptor : SaveChangesInterceptor
{
    ...
    public async override ValueTask<InterceptionResult<int>> SavingChangesAsync(DbContextEventData eventData, InterceptionResult<int> result, CancellationToken cancellationToken = new())
    {
